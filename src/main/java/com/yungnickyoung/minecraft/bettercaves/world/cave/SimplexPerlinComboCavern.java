...
public class SimplexPerlinComboCavern extends BetterCave {
    private SimplexNoiseGen simplexNoiseGen;
    private PerlinNoiseGen perlinNoiseGen;

    public SimplexPerlinComboCavern(World world) {
        super(world);
                ...
                for (int localZ = 0; localZ < 16; localZ++) {
                    ...
                    if (realY <= perlinCavernTop) {
                        ...
                        if (realY >= perlinCavernTransitionBoundary)
                            noiseThreshold *= (1 + Math.min((float)(realY - perlinCavernTransitionBoundary) / (perlinCavernTop - perlinCavernTransitionBoundary), .5f));
