...
public class ConfigCubicCave {
    ...
    public ConfigCubicCave(final ForgeConfigSpec.Builder builder) {
        ...
        caveFrequency = builder
                .comment(" Determines how frequently Type 1 Caves spawn. If this is anything but VeryCommon (the default), vanilla caves will " +
                        "replace some of the areas where Type 1 Caves would have generated.\n However, if vanilla caves are disabled, " +
