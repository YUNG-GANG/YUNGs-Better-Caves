...
public class ConfigFlooredCavern {
    ...
    @Config.Name("Floored Cavern Frequency Custom Value")
    @Config.Comment("Custom value for cavern frequency. Only works if Floored Cavern Frequency is set to Custom. 0 = 0% chance of spawning, " +
