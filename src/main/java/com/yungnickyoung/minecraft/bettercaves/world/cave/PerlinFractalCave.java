 ...
 */
public class PerlinFractalCave extends BetterCave {
    public PerlinFractalCave(World world) {
        super(world);
...
//                    float noise5 = noiseGenerator5.GetNoise(f.x, f.y, f.z);
                    ...
                    if (Configuration.perlinFractalCave.yNoiseAdjustment) {
                        ...
                        if (realY < maxHeight - 1) {
                            ...
                            if (noise1 * noise2 * noise3 * noise4 > aboveTriple.n1 * aboveTriple.n2 * aboveTriple.n3 * aboveTriple.n4) {
...
//                                aboveTriple.n5 = (.2f * aboveTriple.n5) + (.8f * noise5);
                        ...
                        if (realY < maxHeight - 2) {
                            ...
                            if (noise1 * noise2 * noise3 * noise4 > twoAboveTriple.n1 * twoAboveTriple.n2 * twoAboveTriple.n3 * twoAboveTriple.n4) {
...
//                                twoAboveTriple.n5 = (.65f * twoAboveTriple.n5) + (.35f * noise5);
                    ...
                    noises[localX][realY][localZ] = new NoiseTriple(noise1, noise2, noise3, noise4); // note that y indices are from 0 to maxSurfaceHeight - 1
                }
            }
        }
        return noises;
...
//                    int state5 = (noise5 > adjustedThreshold && noise5 < Configuration.perlinFractalCave.topThreshold) ? 1 : 0;
                    ...
                    if (Settings.DEBUG_LOG_ENABLED) {
                        ...
                        float noise = (noise1 + noise2 + noise3 + noise4) / 4f;
    ...
    private static class NoiseTriple {
        ...
        public NoiseTriple(float n1, float n2, float n3, float n4) {
            this.n1 = n1;
            this.n2 = n2;
            this.n3 = n3;
            this.n4 = n4;
