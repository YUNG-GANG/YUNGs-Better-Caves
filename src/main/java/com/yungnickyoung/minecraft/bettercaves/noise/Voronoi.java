...
/**
 * This class provides a modified version of FastNoise's Cellular noise w/ Natural
 * distance function that smooths boundaries between adjacent Voronoi cells.
 */
public class Voronoi {
    ...
    /**
     * Modified version of FastNoise's Cellular noise (with Natural distance) that smooths edges between regions
     * using a decaying exponential of distances.
