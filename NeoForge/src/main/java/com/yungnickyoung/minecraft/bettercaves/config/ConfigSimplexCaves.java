...
public class ConfigSimplexCaves {
    public final ModConfigSpec.IntValue caveBottom;
    public final ModConfigSpec.IntValue caveTop;
    public final ModConfigSpec.IntValue caveSurfaceCutoff;
    public final ModConfigSpec.DoubleValue yCompression;
    public final ModConfigSpec.DoubleValue xzCompression;
    public final ModConfigSpec.IntValue cavePriority;
    public final Advanced advancedSettings;

    public ConfigSimplexCaves(final ModConfigSpec.Builder BUILDER) {
        BUILDER
                .comment(
                        "##########################################################################################################\n" +
        ...
        advancedSettings = new ConfigSimplexCaves.Advanced();
