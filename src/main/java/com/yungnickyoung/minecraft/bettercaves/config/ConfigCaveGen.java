...
public class ConfigCaveGen {
    ...
    @Config.Comment("Parameters used in the generation of cave systems. Does not include large caverns " +
            "at low altitudes.")
    public ConfigSimplexCave simplexFractalCave = new ConfigSimplexCave();

    @Config.Name("Cavern Generation Settings")
    @Config.Comment("Parameters used in the generation of large cavernous systems found at low altitudes.")
