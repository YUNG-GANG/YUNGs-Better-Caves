...
public class SimplexCavePerlinCavern {
    private World world;
    private long seed;
    ...
    public SimplexCavePerlinCavern(World world) {
        this.world = world;
...
//        }
        ...
        int perlinCavernTransitionBoundary = Configuration.caveSettings.invertedPerlinCavern.caveTransition;
